      ...
      <main className="lg:ml-72 min-h-screen">
        ...
        <header className="sticky top-0 z-40 flex h-20 w-full items-center justify-between px-6 lg:px-10 glass-panel border-b border-white/5">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-bold text-white tracking-tight hidden sm:block">Overview</h2>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="lg:hidden w-10 h-10 rounded-full bg-gradient-to-r from-secondary to-primary flex items-center justify-center text-white font-black text-sm shadow-inner">
              {session?.user?.name?.charAt(0).toUpperCase() || 'G'}
            </div>
          </div>
        </header>
        ...
        {/* Content Canvas */}
        <div className="p-6 lg:p-10 space-y-8 max-w-[1440px] mx-auto pb-24">
          
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-4">
            {/* Profil TK/PAUD */}
            <div className="lg:col-span-8 glass-card rounded-[2rem] p-8 relative overflow-hidden flex flex-col justify-center shadow-lg border-white/5">
              ...
              <div className="flex items-center gap-6 relative z-10">
                <div className="w-24 h-24 rounded-[2rem] bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white shadow-xl shadow-indigo-500/20 shrink-0">
                  <span className="material-symbols-outlined text-5xl" data-icon="school">school</span>
                </div>
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="text-3xl font-black text-white tracking-tight">{schoolInfo.schoolName}</h3>
                    <span className="px-3 py-1 rounded-md bg-emerald-500/20 text-emerald-400 text-xs font-black uppercase tracking-widest border border-emerald-500/30">Akreditasi A</span>
                  </div>
            ...
            <div className="lg:col-span-4 bg-gradient-to-br from-indigo-900 to-blue-900 rounded-[2rem] p-8 relative overflow-hidden shadow-lg border border-white/10 flex flex-col justify-center">
              <div className="absolute top-0 right-0 p-6 opacity-30">
                <span className="material-symbols-outlined text-6xl" data-icon="group">group</span>
              </div>
              <div className="relative z-10">
                <p className="text-slate-300 font-bold uppercase tracking-widest text-xs mb-1">Total Peserta Didik</p>
                <div className="flex items-end gap-3">
                  <span className="text-6xl font-black text-white leading-none">{totalStudents}</span>
                  <span className="text-indigo-300 font-bold mb-1">Siswa</span>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="glass-card rounded-[2rem] p-6 flex items-center gap-5 border-white/5">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center text-white shadow-lg shadow-emerald-500/20 shrink-0">
                <span className="material-symbols-outlined text-3xl" data-icon="badge">badge</span>
              </div>
              <div>
                <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px] mb-1">Tenaga Pendidik</p>
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-black text-white leading-none">{totalGuru}</span>
                  <span className="text-slate-500 font-bold text-sm">Guru Aktif</span>
                </div>
              </div>
            </div>

            <div className="glass-card rounded-[2rem] p-6 flex items-center gap-5 border-white/5">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-600 flex items-center justify-center text-white shadow-lg shadow-amber-500/20 shrink-0">
              ...
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-black text-white leading-none">{totalKelas}</span>
                  <span className="text-slate-500 font-bold text-sm">Kelas</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <section className="mt-12">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold tracking-tight">Murid Terakhir Diedit</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="glass-card rounded-[2rem] p-6 flex flex-col gap-6 relative overflow-hidden group hover:bg-white/5 transition-all">
                <div className="absolute top-0 right-0 p-6">
                  <div className="w-3 h-3 rounded-full bg-emerald-400 shadow-[0_0_12px_#34d399]"></div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-[1.5rem] bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center text-white text-xl font-black shadow-lg">
                    A
                  </div>
                  <div>
                    <h4 className="text-lg font-bold text-white tracking-tight">Adi Putra</h4>
                ...
                <Link to="/editor/1" className="w-full py-3 bg-white/10 hover:bg-white/20 text-white rounded-xl text-sm font-bold text-center transition-all">Edit Raport</Link>
              </div>

              {/* Modern Contact Card 2 */}
              <div className="glass-card rounded-[2rem] p-6 flex flex-col gap-6 relative overflow-hidden group hover:bg-white/5 transition-all border-primary/30">
                <div className="absolute top-0 right-0 p-6">
                  <div className="w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_12px_#fbbf24] animate-pulse"></div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-[1.5rem] bg-gradient-to-br from-amber-400 to-orange-600 flex items-center justify-center text-white text-xl font-black shadow-lg">
                    B
                  </div>
                  <div>
                    <h4 className="text-lg font-bold text-white tracking-tight">Budi Santoso</h4>
                ...
                <Link to="/editor/2" className="w-full py-3 bg-primary hover:bg-primary/80 text-white rounded-xl text-sm font-bold text-center transition-all shadow-lg shadow-primary/20">Lanjutkan</Link>
              </div>
